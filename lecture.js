...
if (currentTopic) {
  ...
  document.title = `${currentTopic.title} — Режиссура интерактивного контента`;
  const description = document.querySelector('meta[name="description"]');
  if (description) description.content = `${currentTopic.title} — курс «Режиссура интерактивного контента»`;
}
