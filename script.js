...
if (motionHero && logoWrap && logoCanvas && !reduceMotion) {
  ...
  mask.src = 'assets/images/logo-mask-crop.png?v=ric1';
  ...
  function drawLogoLight() {
    ...
    drawMaskedGradient(() => {
      ...
      g.addColorStop(0, 'rgba(92,42,106,0.02)');
      g.addColorStop(0.38, 'rgba(170,82,190,0.12)');
      g.addColorStop(0.70, 'rgba(224,130,242,0.40)');
      g.addColorStop(1, 'rgba(246,205,255,0.72)');
      fillCtx.fillStyle = g;
    ...
    if (currentInner > 0.002) {
      drawMaskedGradient(() => {
        ...
        rg.addColorStop(0, 'rgba(252,225,255,0.96)');
        rg.addColorStop(0.16, 'rgba(237,170,250,0.74)');
        rg.addColorStop(0.36, 'rgba(216,120,235,0.34)');
        rg.addColorStop(0.72, 'rgba(111,52,128,0.06)');
        rg.addColorStop(1, 'rgba(111,52,128,0)');
